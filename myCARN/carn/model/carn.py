...
class Net(nn.Module):
    def __init__(self, **kwargs):
        ...
        group = kwargs.get("group", 1)  # 字典里没有group则返回的是1

        self.sub_mean = ops.MeanShift((0.4488, 0.4371, 0.4040), sub=True)  # 减去均值
        self.add_mean = ops.MeanShift((0.4488, 0.4371, 0.4040), sub=False)  # 最后要加回去均值
