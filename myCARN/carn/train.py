...
def parse_args():
    ...
    parser.add_argument("--print_interval", type=int, default=10)  # 1000被改为了10
    parser.add_argument("--train_data_path", type=str, 
                        default="E:/project/datasets/ASR data/Visdrone_train_.h5")  # 该处被置换为绝对路径
    ...
    parser.add_argument("--max_steps", type=int, default=100)  # 200000被改为1000
